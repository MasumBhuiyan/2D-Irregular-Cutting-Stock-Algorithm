...
int main(int argc, char const *argv[])
{
    ...
    bin_packing::runDataset("../tests/dataset/", "dighe1", 200);
    bin_packing::runDataset("../tests/dataset/", "dagli", 120);
    bin_packing::runDataset("../tests/dataset/", "poly1a", 100);
    ...
    bin_packing::runDataset("../tests/dataset/", "albano", 11000);
    return 0;
}